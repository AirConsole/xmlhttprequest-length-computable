...
arguments[1]);a.xmlHTTPRequestLengthComputable.progress_listeners.push([c,arguments[1]]);return a[b].call(a,arguments[0],c,arguments[2],arguments[3])}return a[b].apply(a,arguments)}:"removeEventListener"==b?function(){if("progress"==arguments[0])for(var c=a.xmlHTTPRequestLengthComputable.progress_listeners,d=0;d<c.length;++d){if(c[d][1]==arguments[1])return c=c.splice(d)[0],a[b].call(a,arguments[0],c[0],arguments[2],arguments[3])}else return a[b].apply(a,arguments)}:"function"==typeof a[b]?function(){return a[b].apply(a,
